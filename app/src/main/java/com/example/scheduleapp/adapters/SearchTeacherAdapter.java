...
public class SearchTeacherAdapter extends RecyclerView.Adapter<SearchTeacherAdapter.SearchViewHolder> {

    private Context context;
    private List<Teacher> list;

    public SearchTeacherAdapter(Context context, List<Teacher> list) {
    ...
    @NonNull
    @Override
    public SearchTeacherAdapter.SearchViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.search_item2, parent, false);
        return new SearchViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull SearchTeacherAdapter.SearchViewHolder holder, int position) {
